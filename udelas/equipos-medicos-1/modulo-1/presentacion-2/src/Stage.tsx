...
/* Paleta del deck. El cian es el color del curso; cada equipo trae
   además su propio acento (`e.color`), que es el que manda dentro
   de su bloque. El oro y el rojo están racionados: oro para lo que
   hay que recordar, rojo solo para lo que puede matar a alguien. */
export const CY   = '#00d4ff'
export const CYM  = '#38bdf8'
export const CYS  = '#7dd3fc'
export const VI   = '#c4a9f0'
export const VID  = '#7c3aed'
export const GO   = '#fbbf24'
export const GOD  = '#f59e0b'
export const RE   = '#f87171'
export const RED  = '#ef4444'
export const GRE  = '#34d399'
export const WH   = '#eef6ff'
export const WD   = 'rgba(238,246,255,0.74)'
export const WF   = 'rgba(238,246,255,0.42)'
export const WG   = 'rgba(238,246,255,0.26)'
  ...
  return (
    <div
      ...
      style={{
        position: 'absolute',
        [side]: -size * 0.1, top,
        fontFamily: font === 'display' ? "'Playfair Display', serif" : "'JetBrains Mono', monospace",
      ...
      <div className={cls} style={{ position: 'absolute', inset: 0, opacity }}>
        ...
        <div
          style={{
            ...
            background: 'linear-gradient(180deg, rgba(3,8,15,0.55) 0%, transparent 26%, transparent 58%, rgba(3,8,15,0.94) 100%)',
          }}
        />
      </div>
      {credit && (
